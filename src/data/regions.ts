...
export const regionGroups: RegionGroup[] = [
  ...
  },
  {
    ...
    subRegionNames: [
      ...
      // 부산해운대구
      // 해운대구 우동은 대표 지역이므로 sitemap 포함(includeInSitemap: true)
      ...
      // 부산수영구
      // 수영구 광안동은 대표 지역이므로 sitemap 포함(includeInSitemap: true)
  ...
  },
  {
    ...
    subRegionNames: [
      ...
      // 울산남구
      // 남구 삼산동은 대표 지역이므로 sitemap 포함(includeInSitemap: true)
      ...
      // 울산울주군
      // 울주군 언양읍은 대표 지역이므로 sitemap 포함(includeInSitemap: true)
  ...
  },
  {
    ...
    dongNames: [],
    subRegionNames: [
      // 함안 가야읍은 대표 지역이므로 sitemap 포함(includeInSitemap: true)
  ...
  },
  {
    ...
    subRegionNames: [
      ...
      { name: "합천용주면", displayName: "합천용주면", parent: "합천", level: "myeon", phase: 3, exposeInHub: true, includeInSitemap: false }
    ],
    phase: 1,
    dongExposeInHub: false,
    dongIncludeInSitemap: false,
  ...
  },
  {
    ...
    dongNames: [],
    subRegionNames: [
      // 남해 남해읍은 대표 지역이므로 sitemap 포함(includeInSitemap: true)
